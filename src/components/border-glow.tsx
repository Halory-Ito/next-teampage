...
interface BorderGlowProps {
  children?: ReactNode
  className?: string
  /** 是否将卡片视为浅色表面（自行判断主题，比解析 backgroundColor 更可靠） */
...
const BorderGlow = ({
  ...
  const isSurfaceLight = lightSurface ?? isLightColor(backgroundColor)
  ...
  return (
    <div
      ...
      style={{
        ...
        borderColor: isSurfaceLight ? 'rgb(24 24 27 / 12%)' : 'rgb(255 255 255 / 15%)',
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          mixBlendMode: isSurfaceLight ? 'normal' : 'soft-light',
          transition: isVisible ? 'opacity 0.25s ease-out' : 'opacity 0.75s ease-in-out',
        } as CSSProperties}
      />
      ...
      <span
        ...
        style={{
          ...
          opacity: glowOpacity,
          mixBlendMode: isSurfaceLight ? 'normal' : 'plus-lighter',
          transition: isVisible ? 'opacity 0.25s ease-out' : 'opacity 0.75s ease-in-out',
        } as CSSProperties}
      >
        <span
